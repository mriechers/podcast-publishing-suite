# OpenAI MCP Documentation (Raw Capture via jina.ai)

- **Source**: https://platform.openai.com/docs/mcp (fetched via https://r.jina.ai mirror due to Cloudflare challenge)
- **Captured**: 2025-12-05
- **Notes**: Preserves the OpenAI guide for building MCP servers, connectors, and safety considerations.

---

Title: Building MCP servers for ChatGPT and API integrations - OpenAI API

URL Source: https://platform.openai.com/docs/mcp
...
[Example MCP server on Replit Remix the server example on Replit to test live.](https://replit.com/@kwhinnery-oai/DeepResearchServer?v=1#README.md)
